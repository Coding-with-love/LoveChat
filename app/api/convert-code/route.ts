...
export async function POST(request: NextRequest) {
  try {
    console.log("🔄 Convert code API called")
    ...
    if (!code || !target) {
      console.error("❌ Missing code or target:", { hasCode: !!code, hasTarget: !!target })
...
Converted ${toDescription} code:`
    ...
    console.log("🤖 Sending conversion request to Google API...")
    ...
    console.log("🎯 Generated code preview:", generatedText.substring(0, 100) + "...")
    ...
    console.log("✨ Final converted code:", {
    ...
    if (threadId && messageId) {
      ...
      console.log("💾 Saving conversion to database with ID:", conversionId)
      ...
      if (saveError) {
        ...
        console.log("✅ Successfully saved conversion to database")
