...
import { Lock, Eye, Calendar, MessageSquare, Share2, ArrowLeft } from "lucide-react"
...
export default function SharedConversation() {
  ...
  const loadSharedConversation = async (passwordAttempt?: string) => {
    try {
      ...
      console.log("🔍 Loading shared conversation:", token, "with password:", !!passwordAttempt)
      ...
      if (errorMessage === "Password required") {
        ...
        setNeedsPassword(true)
      } else if (errorMessage === "This shared conversation has expired") {
