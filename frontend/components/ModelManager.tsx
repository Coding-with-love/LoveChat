...
export function ModelManager() {
  ...
  const modelMatchesFilters = (modelInfo: ModelInfo): boolean => {
    ...
    if (filters.providers.length > 0) {
      const providerMatch = filters.providers.some(
        (provider) => modelInfo.provider.toLowerCase() === provider,
      );
  ...
  return (
    <div className="space-y-6">
                        ...
                        {filterOptions.providers.map((provider) => (
                          ...
                          >
                            <Switch
                              ...
                              onCheckedChange={() =>
                                updateFilter("providers", provider.value)
                              }
                              className="scale-75"
                            />
                            <label
                        ...
                        {filterOptions.features.map((feature) => (
                          ...
                          >
                            <Switch
                              ...
                              onCheckedChange={() =>
                                updateFilter("features", feature.value)
                              }
                              className="scale-75"
                            />
                            <label
                        ...
                        {filterOptions.capabilities.map((capability) => (
                          ...
                          >
                            <Switch
                              ...
                              onCheckedChange={() =>
                                updateFilter("capabilities", capability.value)
                              }
                              className="scale-75"
                            />
                            <label
            ...
            {getActiveFilterCount() > 0 && (
              <div className="flex items-center gap-2 flex-wrap bg-background/50 rounded-md p-2 border">
                ...
                {filters.providers.map((provider) => (
                  ...
                  >
                    {
                      filterOptions.providers.find((p) => p.value === provider)
                        ?.label
                    }
                    <button
                ...
                {filters.features.map((feature) => (
                  ...
                  >
                    {
                      filterOptions.features.find((f) => f.value === feature)
                        ?.label
                    }
                    <button
                ...
                {filters.capabilities.map((capability) => (
                  ...
                  >
                    {
                      filterOptions.capabilities.find(
      ...
      <Dialog
        open={selectedDetailModel !== null}
        onOpenChange={() => setSelectedDetailModel(null)}
      >
            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    {
                      getDetailedModelInfo(selectedDetailModel)
                        .detailedDescription
                    }
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {getDetailedModelInfo(selectedDetailModel).features.map(
                      (feature, index) => (
                        <Badge
                          key={index}
                          variant="secondary"
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {getDetailedModelInfo(selectedDetailModel).capabilities.map(
                      (capability, index) => (
                        <li
                          key={index}
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {getDetailedModelInfo(selectedDetailModel).bestUseCases.map(
                      (useCase, index) => (
                        <li
                          key={index}
                          className="text-sm text-muted-foreground flex items-center gap-2"
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {getDetailedModelInfo(selectedDetailModel).limitations.map(
                      (limitation, index) => (
                        <li
                          key={index}
                          className="text-sm text-muted-foreground flex items-center gap-2"
                ...
                <div className="pt-4 border-t">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <p className="text-sm font-medium">
                        Status:{" "}
                        {getDetailedModelInfo(selectedDetailModel).hasApiKey
                          ? "Available"
                          : "Requires API Key"}
                      </p>
                      {getDetailedModelInfo(selectedDetailModel)
                    ...
                    <Switch
                      checked={
                        getDetailedModelInfo(selectedDetailModel).isEnabled
                      }
                      onCheckedChange={() =>
                        handleToggleModel(selectedDetailModel)
                      }
                      disabled={
                        !getDetailedModelInfo(selectedDetailModel).hasApiKey
                      }
